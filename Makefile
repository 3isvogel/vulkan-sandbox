...
CXXFLAGS = -std=c++17
# C/C++ flags
CPPFLAGS = -O2 # -DHIDE_LOG_LEVEL # -DHIDE_LOG_TRACE # -DBUILD_RELEASE # -DLOG_DISABLE_COLOR
...
# Unused: Objects are created using `find`
...
release: CPPFLAGS += -DBUILD_RELEASE
release: all

run: all
	@./bin/app || echo "If surface creation fails unexpectedly, try running it from outside make"
