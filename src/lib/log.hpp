...
#define logTrace(level, ...) logPrint(level, __FILE__, __LINE__, __VA_ARGS__)

#define logError(...) logTrace(LOG_LEVEL_ERROR, __VA_ARGS__)

#ifndef BUILD_RELEASE

#define logAlloc(...) logTrace(LOG_LEVEL_ALLOC, __VA_ARGS__)
#define logDebug(...) logTrace(LOG_LEVEL_DEBUG, __VA_ARGS__)
#define logInfo(...) logTrace(LOG_LEVEL_INFO, __VA_ARGS__)
#define logWarning(...) logTrace(LOG_LEVEL_WARNING, __VA_ARGS__)
